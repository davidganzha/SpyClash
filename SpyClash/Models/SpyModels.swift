    ...
    var profile: ProfileCopy {
        ...
        case .ru:
            ProfileCopy(
                ...
                cancel: "ОТМЕНА",
                deleteDialogMessage: "Это навсегда удалит профиль, историю игр, пользовательские наборы и социальные данные. Ограниченные записи безопасности и модерации могут храниться, если этого требует закон.",
                ...
                dangerBody: "Удаление аккаунта стирает профиль, пользовательские наборы и архив.",
    ...
    var wordPacks: WordPacksCopy {
        ...
        case .ru:
            WordPacksCopy(
                ...
                createFirstPack: "СОЗДАТЬ ПЕРВЫЙ НАБОР",
                customFallback: "СВОЙ",
                wordsSuffix: "СЛОВ",
                removingPack: "УДАЛЕНИЕ НАБОРА",
                deleteDialogTitle: "УДАЛИТЬ НАБОР",
                ...
                editor: WordPackEditorCopy(
                    ...
                    createPack: "СОЗДАТЬ НАБОР",
                    savePack: "СОХРАНИТЬ НАБОР",
                    signInRequired: "НУЖЕН ВХОД",
                    packNeedsNameAndWords: "НАБОРУ НУЖНЫ НАЗВАНИЕ И МИНИМУМ ДВА СЛОВА",
    ...
    var game: GameCopy {
        ...
        case .ru:
            GameCopy(
                ...
                wordSource: "ИСТОЧНИК СЛОВ",
                builtinIntel: "ВСТРОЕННЫЙ INTEL",
                syncingWordPacks: "СИНХРОНИЗАЦИЯ НАБОРОВ",
                customPacksAvailableSuffix: "СВОИХ НАБОРОВ ДОСТУПНО",
                wordsSuffix: "СЛОВ",
                customPackUnavailable: "НАБОР НЕДОСТУПЕН",
