    ...
    private var englishSections: [LegalSection] {
        ...
        case .terms:
            [
                ...
                LegalSection(
                    title: "11. CURRENT IOS RELEASE",
                    text: "This iOS release includes every feature at no charge and has no checkout. Separate historical agreements created outside this release remain managed by their providers and are not ended by deleting a SpyClash account."
                ),
                LegalSection(
    ...
    var spanishSections: [LegalSection] {
        ...
        case .terms:
            [
                ...
                LegalSection(
                    title: "11. VERSIÓN ACTUAL PARA IOS",
                    text: "Esta versión para iOS incluye todas las funciones sin coste y no tiene proceso de pago. Los acuerdos históricos independientes creados fuera de esta versión siguen siendo gestionados por sus proveedores y no finalizan al eliminar una cuenta de SpyClash."
                ),
                LegalSection(
    ...
    var russianSections: [LegalSection] {
        ...
        case .terms:
            [
                ...
                LegalSection(
                    title: "11. ТЕКУЩАЯ ВЕРСИЯ ДЛЯ IOS",
                    text: "Эта версия для iOS включает все функции бесплатно и не содержит оформления платежа. Отдельные исторические соглашения, созданные вне этой версии, остаются под управлением их поставщиков и не прекращаются при удалении учетной записи SpyClash."
                ),
                LegalSection(
    ...
    var ukrainianSections: [LegalSection] {
        ...
        case .terms:
            [
                ...
                LegalSection(
                    title: "11. ПОТОЧНА ВЕРСІЯ ДЛЯ IOS",
                    text: "Ця версія для iOS містить усі функції безкоштовно й не має оформлення платежу. Окремі історичні угоди, створені поза цією версією, залишаються під керуванням їхніх постачальників і не припиняються після видалення облікового запису SpyClash."
                ),
                LegalSection(
                    title: "12. ЗМІНИ УМОВ",
