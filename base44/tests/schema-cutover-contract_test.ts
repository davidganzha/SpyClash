...
Deno.test("additive schema stages every field required by coordinated functions", async () => {
  ...
  for (
    const field of [
      ...
      "add_optional_field GameHistory result_key",
      "add_optional_field GameHistory profile_repair_state",
      "add_optional_field GameHistory profile_repair_token",
      "add_optional_field GameHistory profile_repair_lease_until",
      "add_optional_field GameHistory profile_repair_attempt_count",
      "add_optional_field GameHistory profile_repair_completed_at",
...
Deno.test("final schema refuses to run before the additive User and history boundary", async () => {
  ...
  for (
    const prerequisite of [
      ...
      "require_live_property GameHistory result_key",
      "require_live_property GameHistory profile_repair_state",
      "require_live_property GameHistory profile_repair_token",
      "require_live_property GameHistory profile_repair_lease_until",
      "require_live_property GameHistory profile_repair_attempt_count",
      "require_live_property GameHistory profile_repair_completed_at",
