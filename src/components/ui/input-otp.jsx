...
/**
 * The wrapper always uses input-otp's children-based composition branch.
 * @typedef {Omit<React.ComponentPropsWithoutRef<typeof OTPInput>, "render" | "children"> & { children: React.ReactNode }} InputOTPProps
 */
